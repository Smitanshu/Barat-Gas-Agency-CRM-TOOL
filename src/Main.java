...
//import java.util.Date;
    ...
    public static void main(String[] args) {
        ...
        Delivery[] deliveryObj = new Delivery[1];

        deliveryObj[0] = new Delivery("Smitanshu", " Shivaji Nagar", "411005", "9823XXXX", "Ghole Road", 1);
        //deliveryObj[1] = new Delivery("Samrat", " Bhumkar Chowk", "411033", "9823XXXX", "Hinjewadi Road", 2);
       // deliveryObj[2] = new Delivery("Ashish", " Kalewadi", "411033", "9823XXXX", "Tathawade", 2);
       // deliveryObj[3] = new Delivery("Sakshi", " Tathawade", "411033", "9823XXXX", "Tathawade", 1);
      //  deliveryObj[4] = new Delivery("Nupoor", " Tathawade", "411033", "9823XXXX", "Tathawade", 2);
        for (Delivery delivery : deliveryObj) {
            ...
            delivery.validate();
            System.out.println("Status after validation: " + delivery.status); // Add this line
            delivery.getDate();
            System.out.println("Status after getDate: " + delivery.status); // Add this line
